...
%>
<h3>Online shopping Bill (EcommerceWebApp | Chandigarh)</h3>
<hr>
...
<h3>Product Details</h3>
  ...
  <%
  ResultSet rs3 = st.executeQuery("select * from cart inner join product on cart.price=product.price and cart.email='"+email+"' and cart.status='bill'");
  while(rs3.next()){
	sno+=1;  
